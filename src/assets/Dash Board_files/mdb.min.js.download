...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
	...
	(function () {
		return function (t, e, i, n) {
						...
						if (v.State.calls[o]) {
							...
							for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
								...
								if (a(C)) {
									...
									for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k)
										if ("element" !== T) {
											...
											if (1 === g)
												...
												if (M = I.startValue + A * P(g, d, A), !p && M === I.currentValue)
													continue
											}
									...
									d.mobileHA && a(C).transformCache.translate3d === n && (a(C).transformCache.translate3d = "(0px, 0px, 0px)", S = !0),
			...
			function c(t, e) {
				...
				for (var i = v.State.calls[t][0], o = v.State.calls[t][1], r = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, c = 0, d = i.length; d > c; c++) {
					...
					if (e || r.loop || ("none" === r.display && b.setPropertyValue(h, "display", r.display), "hidden" === r.visibility && b.setPropertyValue(h, "visibility", r.visibility)), !0 !== r.loop && (u.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(u.queue(h)[1])) && a(h)) {
						...
						r.mobileHA && (f = !0, delete a(h).transformCache.translate3d),
			...
			p = !1;
			if (t.fn && t.fn.jquery ? (u = t, p = !0) : u = e.Velocity.Utilities, 8 >= d && !p)
				...
				var b = v.CSS = {
					...
					getPropertyValue : function (t, i, o, r) {
						...
						if (b.Hooks.registered[i]) {
							...
							var f,
							p;
							"transform" !== (f = b.Normalizations.registered[i]("name", t)) && (p = s(t, b.Names.prefixCheck(f)[0]), b.Values.isCSSNullValue(p) && b.Hooks.templates[i] && (p = b.Hooks.templates[i][1])),
					...
					function r() {
						function t(t) {
							function h(t, e) {
								...
								o = n,
								a = n;
								return f.isArray(t) ? (i = t[0], !f.isArray(t[1]) && /^[\d-]/.test(t[1]) || f.isFunction(t[1]) || b.RegEx.isHex.test(t[1]) ? a = t[1] : (f.isString(t[1]) && !b.RegEx.isHex.test(t[1]) || f.isArray(t[1])) && (o = e ? t[1] : s(t[1], c.duration), t[2] !== n && (a = t[2]))) : i = t,
								e || (o = o || c.easing),
							...
							if ("scroll" === M) {
								...
								for (var O in a(r).tweensContainer && !0 === a(r).isAnimating && (D = a(r).tweensContainer), u.each(y, function (t, e) {
									...
									if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
										...
										c._cacheValues && D && D[O] ? (N === n && (N = D[O].endValue + D[O].unitType), V = a(r).rootPropertyValueCache[z]) : b.Hooks.registered[O] ? N === n ? (V = b.getPropertyValue(r, z), N = b.getPropertyValue(r, O, V)) : V = b.Hooks.templates[z][1] : N === n && (N = b.getPropertyValue(r, O));
										var B,
										j,
										Y,
										$ = !1;
										if (N = (B = p(O, N))[0], Y = B[1], W = (B = p(O, W))[0].replace(/^([+-\/*])=/, function (t, e) {
												return $ = e,
												""
											}), j = B[1], N = parseFloat(N) || 0, W = parseFloat(W) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (W /= 100, j = "em") : /^scale/.test(O) ? (W /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (W = W / 100 * 255, j = "")), /[\/*]/.test($))
											j = Y;
										else if (Y !== j && 0 !== N)
											if (0 === W)
												j = Y;
					...
					if (f.isWrapped(this) ? (d = !1, p = 0, g = this, h = this) : (d = !0, p = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
							...
							if (!u.isPlainObject(y) || f.isEmptyObject(y)) {
								if (f.isString(y) && v.Redirects[y]) {
									...
									u.each(g, function (t, e) {
										...
										O.drag && (O.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : m), O.duration = Math.max(O.duration * (O.backwards ? 1 - t / C : (t + 1) / C), .75 * O.duration, 200)),
						...
						if (u.each(g, function (t, e) {
							...
							for (var R = 0; E > R; R++) {
								...
								R === E - 1 && (W.display = O.display, W.visibility = O.visibility, W.complete = O.complete),
								x(g, "reverse", W)
							}
						return t()
					}
					...
					t.controllers.bar = t.DatasetController.extend({
							...
							calculateBarValuePixels : function (t, e) {
								...
								if (f || void 0 === f && void 0 !== p)
									for (i = 0; i < t; ++i)
										(n = l.getDatasetMeta(i)).bar && n.stack === p && n.controller.getValueScaleId() === u.id && l.isDatasetVisible(i) && (o = u.getRightValue(d[i].data[e]), (h < 0 && o < 0 || h >= 0 && o > 0) && (m += o));
							...
							calculateBarIndexPixels : function (t, e, i) {
								...
								p = i.start,
								m = i.end;
								return 1 === f ? (n = h > p ? h - p : m - h, o = h < m ? m - h : h - p) : (e > 0 && (n = (h - d[e - 1]) / 2, e === f - 1 && (o = n)), e < f - 1 && (o = (d[e + 1] - h) / 2, 0 === e && (n = o))),
				...
				e.exports = function (t) {
					...
					t.controllers.line = t.DatasetController.extend({
							...
							update : function (t) {
								...
								for (p && 0 !== l._model.tension && r.updateBezierControlPoints(), i = 0, n = c.length; i < n; ++i)
									c[i].pivot()
							},
				...
				e.exports = function (t) {
					...
					o.extend(t.prototype, {
						...
						destroy : function () {
							...
							a = this,
							s = a.canvas;
							for (a.stop(), i = 0, n = a.data.datasets.length; i < n; ++i)
								a.destroyDatasetMeta(i);
							s && (a.unbindEvents(), o.canvas.clear(a), r.releaseContext(a.ctx), a.canvas = null, a.ctx = null),
							e.notify(a, "destroy"),
						...
						eventHandler : function (t) {
							...
							if (!1 !== e.notify(i, "beforeEvent", [t])) {
								...
								return a ? i.render(a) : o && !i.animating && (i.stop(), i.render(i.options.hover.animationDuration, !0)),
								i._bufferedRender = !1,
								i._bufferedRequest = null,
								i
							}
						...
						update : function (t, o, a) {
							if (t) {
								...
								n.each(h.concat(f, p, m), function (t) {
									var e,
									i = t.isHorizontal();
									i ? (e = t.update(t.fullWidth ? v : k, w), C -= e.height) : (e = t.update(x, b), k -= e.width),
									S.push({
										horizontal : i,
										minSize : e,
										box : t
					...
					t.Scale = o.extend({
							...
							fit : function () {
								...
								if (c.display && h) {
									...
									if (f) {
										...
										c.mirror ? v = 0 : v += x + b, n.width = Math.min(t.maxWidth, n.width + v), t.paddingTop = p.size / 2, t.paddingBottom = p.size / 2
								}
								t.handleMargins(),
								t.width = n.width,
								t.height = n.height
							...
							_autoSkip : function (t) {
								...
								for (l.maxTicksLimit && (o = l.maxTicksLimit), s && (e = !1, (h + l.autoSkipPadding) * c > r.width - (r.paddingLeft + r.paddingRight) && (e = 1 + Math.floor((h + l.autoSkipPadding) * c / (r.width - (r.paddingLeft + r.paddingRight)))), o && c > o && (e = Math.max(e, Math.floor(c / o)))), i = 0; i < c; i++)
									n = t[i], (e > 1 && i % e > 0 || i % e == 0 && i + e >= c) && i !== c - 1 && delete n.label, f.push(n);
								return f
							},
							draw : function (t) {
								var e = this,
								...
								if (o.display) {
									...
									if (a.each(g, function (i, n) {
											if (!a.isNullOrUndef(i.label)) {
												...
												if (m) {
													...
													var z,
													V = "left" === o.position;
													u.mirror ? (F = V ? "left" : "right", z = W) : (F = V ? "right" : "left", z = w + W),
											...
											if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
												...
												if (a.isArray(e))
													for (var i = 0, n = 0; i < e.length; ++i)
														s.fillText("" + e[i], 0, n) , n += 1.5 * y.size;
													else
														s.fillText(e, 0, 0);
													s.restore()
												}
											...
											L = r(f) / 2;
											if (m)
												_ = e.left + (e.right - e.left) / 2, E = "bottom" === o.position ? e.bottom - L - S.bottom : e.top + L + S.top;
											else {
									...
									if (h.drawBorder) {
										...
										m ? (H = N = "top" === o.position ? e.bottom : e.top, H += z, N += z) : (R = W = "left" === o.position ? e.right : e.left, R += z, W += z),
										s.beginPath(),
										s.moveTo(R, H),
										s.lineTo(W, N),
										s.stroke()
				...
				e.exports = function (t) {
					...
					t.Tooltip = o.extend({
							...
							update : function (e) {
								...
								if (m.length) {
									...
									for (i = 0, n = m.length; i < n; ++i)
										C.push((o = m[i], s = void 0, l = void 0, void 0, void 0, s = o._xScale, l = o._yScale || o._scale, c = o._index, u = o._datasetIndex, {
							...
							getCaretPosition : function (t, e, i) {
								...
								g = e.height;
								if ("center" === h)
									s = p + g / 2, "left" === d ? (o = (n = f) - c, a = n, r = s + c, l = s - c) : (o = (n = f + m) + c, a = n, r = s - c, l = s + c);
								else if ("left" === d ? (n = (o = f + u + c) - c, a = o + c) : "right" === d ? (n = (o = f + m - u - c) - c, a = o + c) : (n = (o = f + m / 2) - c, a = o + c), "top" === h)
									s = (r = p) - c, l = r;
								else {
									s = (r = p + g) + c,
									l = r;
							...
							handleEvent : function (t) {
								...
								i = e._options,
								n = !1;
								if (e._lastActive = e._lastActive || [], "mouseout" === t.type ? e._active = [] : e._active = e._chart.getElementsAtEventForMode(t, i.mode, i), !(n = !a.arrayEquals(e._active, e._lastActive)))
									return !1;
				...
				e.exports = function () {
					...
					return {
						...
						afterDatasetsUpdate : function (t, n) {
							...
							f = [];
							for (l = 0; l < d; ++l)
								u = null, (c = (a = t.getDatasetMeta(l)).dataset) && c._model && c instanceof o.Line && (u = {
							...
							for (l = 0; l < d; ++l)
								(u = f[l]) && (u.fill = r(f, l, h), u.boundary = i(u), u.mapper = s(u))
						},
							...
							if (i) {
								...
								d && h && u.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
									...
									for (t.beginPath(), r = 0, s = m + !!a; r < s; ++r)
										h = i(d = e[u = r % m]._view, u, n), f = l(d), p = l(h), f && p ? (b = v.push(d), x = y.push(h)) : b && x && (g ? (f && v.push(d), p && y.push(h)) : (c(t, v, y, b, x), b = x = 0, v = [], y = []));
									c(t, v, y, b, x),
									t.closePath(),
									t.fillStyle = o,
									t.fill()
										...
										function (t, i, n) {
											if (!(isNaN(y) || y <= 0)) {
												...
												if (d.setLineDash && d.setLineDash(h(n.lineDash, s.borderDash)), e.labels && e.labels.usePointStyle) {
													...
													r || d.strokeRect(t, i, y, p), d.fillRect(t, i, y, p);
												d.restore()
											}
										}
										(g, v, n),
				...
				e.exports = function (t) {
					...
					i = t.Scale.extend({
							...
							getValueForPixel : function (t) {
								...
								return o.isHorizontal() ? (i = o.width, e = o.start * Math.pow(10, (t - o.left) * a / i)) : (i = o.height, e = Math.pow(10, (o.bottom - t) * a / i) / o.start),
								e
							}
						});
				...
				e.exports = function (t) {
					var e = t.Scale.extend({
								...
								for (t = 0, i = (f.data.datasets || []).length; t < i; ++t)
									if (f.isDatasetVisible(t))
										if (l = f.data.datasets[t].data, a.isObject(l[0]))
											for (b[t] = [], e = 0, o = l.length; e < o; ++e)
												c = p(l[e], h), y.push(c), b[t][e] = c;
										else
											y.push.apply(y, x), b[t] = x.slice(0);
									else
										b[t] = [];
								x.length && (x = d(x).sort(u), g = Math.min(g, x[0]), v = Math.max(v, x[x.length - 1])),
								y.length && (y = d(y).sort(u), g = Math.min(g, y[0]), v = Math.max(v, y[y.length - 1])),
								g = p(m.min, h) || g,
								v = p(m.max, h) || v,
							...
							buildTicks : function () {
								...
								for ("ticks" === s.bounds && d.length && (a = d[0], r = d[d.length - 1]), a = p(u.min, o) || a, r = p(u.max, o) || r, t = 0, e = d.length; t < e; ++t)
							...
							getPixelForValue : function (t, e, i) {
								var n = null;
								if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = p(t, this)), null !== n)
...
("object" == typeof global ? global : this, function () {
	...
	t(document).ready(function () {
		...
		t(".hiddendiv").first().length || ($hiddenDiv = t('<div class="hiddendiv common"></div>'), t("body").append($hiddenDiv)),
		...
		return function () {
			...
			function u(i) {
				...
				if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), !function (t, e) {
					...
					i.title && (f.append(i.title).addClass(a.titleClass), u.append(f)),
					i.message && (p.append(i.message).addClass(a.messageClass), u.append(p)),
	...
	t.fn.dropdown = function (e) {
		...
		this.each(function () {
			...
			function l(e) {
				...
				if ("left" === d)
					h = o.gutter, f = n.position().left + h;
				else if ("right" === d) {
...
(jQuery), function (t, e, i, n) {
	...
	function G(t, e, i) {
		...
		function (t, e) {
			...
			e.scale = s ? (f = s.pointers, p = o, it(p[0], p[1], Q) / it(f[0], f[1], Q)) : 1,
	...
	v(ht, Z, {
		handler : function (t) {
			...
			o & R && (0 === t.button || r) ? s < 0 && (e.push(t), s = e.length - 1) : o & (H | N) && (i = !0),
	...
	v(bt, Z, {
		handler : function (t) {
			...
			i = function (t, e) {
				...
				o = 0;
				for (; o < r.length; )
					n[r[o].identifier] && s.push(r[o]), e & (H | N) && delete n[r[o].identifier], o++;
				if (!s.length)
					return;
	...
	Nt.prototype = {
		...
		recognizeWith : function (t) {
			...
			return e[(t = Bt(t, this)).id] || (e[t.id] = t, t.recognizeWith(this)),
			this
		},
		...
		requireFailure : function (t) {
			...
			return -1 === M(e, t = Bt(t, this)) && (e.push(t), t.requireFailure(this)),
			this
		},
	...
	v(Yt, jt, {
		...
		directionTest : function (t) {
			...
			a = t.deltaX,
			r = t.deltaY;
			return o & e.direction || (e.direction & $ ? (o = 0 === a ? z : a < 0 ? V : B, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? z : r < 0 ? j : Y, i = r != this.pY, n = Math.abs(t.deltaY))),
			t.direction = o,
	...
	v(Xt, Nt, {
		...
		process : function (t) {
			...
			if (this._input = t, !n || !i || t.eventType & (H | N) && !o)
				this.reset();
		...
		recognize : function (t) {
			...
			if (!e.stopped) {
				...
				for (var a = 0; a < n.length; )
					i = n[a], 2 === e.stopped || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (Lt | Ft | Rt) && (o = e.curRecognizer = i), a++
			}
		},
		get : function (t) {
			if (t instanceof Nt)
		...
		function c(u, d) {
			...
			v.hammer({
				...
				if ("touch" === e.gesture.pointerType) {
					...
					if ("left" === d.edge && (i > d.MENU_WIDTH ? i = d.MENU_WIDTH : i < 0 && (i = 0)), "left" === d.edge)
						i < d.MENU_WIDTH / n ? f = !1 : i >= d.MENU_WIDTH / n && (f = !0), h.menu_id.css("transform", "translateX(" + (i - d.MENU_WIDTH) + "px)");
					else {
						...
						t(this).click(function (r) {
							if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
								...
								o ? (t('input[type="checkbox"]', this).prop("checked", function (t, e) {
										return !e
									}), s = i(f, v ? b ? t(this).index() - t(this).prevAll(".optgroup").length - 1 : t(this).index() - 1 : b ? t(this).index() - t(this).prevAll(".optgroup").length : t(this).index(), n), C.trigger("focus")) : (d.find("li").removeClass("active"), t(this).toggleClass("active"), C.val(t(this).text())),
								S(d, t(this)),
						...
						if (9 != e.which)
							if (40 != e.which || d.is(":visible")) {
								if (13 != e.which || d.is(":visible")) {
									...
									40 == e.which && (a = d.find("li.selected").length ? d.find("li.selected").next("li:not(.disabled)")[0] : d.find("li:not(.disabled)")[0], S(d, a)),
...
(function (t) {
	...
	function a(e, l, u, d) {
		...
		y = v.prototype = {
			...
			render : function (e) {
				return e ? (y.$holder = t(b()), x(), y.$root.html(y.$holder)) : y.$root.find("." + m.box).html(y.component.nodes(f.open)),
				y.trigger("render")
			},
			stop : function () {
			...
			close : function (t) {
				...
				f.open ? (f.open = !1, h && n.css("overflow", "").css("padding-right", "-=" + r()), i.off("." + f.id), y.trigger("close")) : y
			},
			clear : function (t) {
			...
			set : function (e, i, n) {
				...
				if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
					for (o in r || (s[e] = i), s)
						a = s[o], o in y.component.item && (void 0 === a && (a = null), y.component.set(o, a, n)), "select" != o && "clear" != o || g.val("clear" == o ? "" : y.get(o, p.format)).trigger("change");
					y.render()
				}
			...
			on : function (e, i, n) {
				...
				if (e)
					for (o in r || (s[e] = i), s)
						a = s[o], n && (o = "_" + o), f.methods[o] = f.methods[o] || [], f.methods[o].push(a);
				return y
			},
			off : function () {
				var t,
...
(function (t, e) {
	...
	o.prototype.validate = function (t, i, o) {
		...
		if ((!o || !o.nav && !o.defaultValue) && (!h && c.disabled(i) || h && c.disabled(i) && (m || a || r) || !h && (i.pick <= f.pick || i.pick >= p.pick)))
			for (h && !m && (!r && d > 0 || !a && d < 0) && (d *= -1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u, d = d > 0 ? 1 : -1), i.pick <= f.pick ? (s = !0, d = 1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : -1)])) : i.pick >= p.pick && (l = !0, d = -1, i = c.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : 1)])), !s || !l); )
	...
	function S(t, e) {
		...
		if (e.twelvehour)
			for (E = 0; E < 12; E += e.hourstep)
				O = R.clone(), L = E / 6 * Math.PI, F = y, O.css("font-size", "140%"), O.css({
		...
		for (E = 0; E < 60; E += H)
			for (E = 0; E < 60; E += 5)
				O = R.clone(), L = E / 30 * Math.PI, O.css({
		...
		function N(t, i) {
			...
			if (!i || !(p < y - x || p > y + x)) {
				...
				a.off(h).on(h, function (t) {
					...
					"hours" === D.currentView ? D.toggleView("minutes", k / 2) : e.autoclose && (D.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
							D.done()
						}, k / 2)),
					l.prepend(z),
					clearTimeout(g),
...
(this, function () {
	...
	return function (t, e, i, n) {
		var o = {
			...
			detectFeatures : function () {
				...
				for (var l, c, u = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], h = 0; 4 > h; h++) {
					e = d[h];
					for (var f = 0; 3 > f; f++)
						l = u[f], c = e + (e ? l.charAt(0).toUpperCase() + l.slice(1) : l), !i[l] && c in t && (i[l] = c);
		...
		Ft = null,
		Rt = function () {
			Ft && (o.unbind(document, "mousemove", Rt), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")),
		...
		Zt = {
			...
			init : function () {
				if (!s && !l) {
					...
					for (W.animationName && W.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < vt.length; i++)
						a["init" + vt[i]]();
					...
					var c = "pswp--open ";
					for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += D ? "pswp--touch" : "pswp--notouch", c += W.animationName ? " pswp--css_animation" : "", c += W.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++)
			...
			updateCurrItem : function (t) {
				if (0 !== mt) {
					...
					if (!(t && 2 > i)) {
						...
						for (var n = 0; i > n; n++)
							mt > 0 ? (e = k.shift(), k[2] = e, Dt((++h + 2) * pt.x, e.el.style), a.setContent(e, u - i + n + 1 + 1)) : (e = k.pop(), k.unshift(e), Dt(--h * pt.x, e.el.style), a.setContent(e, u + i - n - 1 - 1));
						if (tt && 1 === Math.abs(mt)) {
							var o = Ne(C);
			...
			updateSize : function (e) {
				if (!gt && r.modal) {
					var i = o.getScrollY();
					if (R !== i && (t.style.top = i + "px", R = i), !e && yt.x === window.innerWidth && yt.y === window.innerHeight)
						return;
				...
				if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, jt(), pt.x = dt.x + Math.round(dt.x * r.spacing), pt.y = dt.y, _t(pt.x * ht), St("beforeResize"), void 0 !== h) {
					for (var n, s, l, c = 0; 3 > c; c++)
						n = k[c], Dt((c + h) * pt.x, n.el.style), l = u + c - 1, r.loop && ze() > 2 && (l = wt(l)), (s = Ne(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && ($e(s, dt), Qe(s), At(s));
					w = !1
				}
				v = g = a.currItem.initialZoomLevel,
		...
		Se = function (t) {
			...
			return A ? (st = 0, ie.forEach(function (t) {
					...
					st++
				})) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (Ce[0] = ye(t.touches[0], we), t.touches.length > 1 && (Ce[1] = ye(t.touches[1], ke))) : (we.x = t.pageX, we.y = t.pageY, we.id = "", Ce[0] = we),
			Ce
		},
		Te = function (t, e) {
			var i,
			...
			l = ut[t] + e[t] * i,
			!r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || X || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && ze() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && ze() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (_t(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
		},
		Me = function (t) {
			if (!("mousedown" === t.type && t.button > 0)) {
				...
				if (!j || "mousedown" !== t.type) {
					...
					Z = null,
					Ut(),
					Y && 1 !== n || (Y = nt = !0, o.bind(window, f, a), V = rt = ot = B = Q = q = $ = X = !1, it = null, St("firstTouchStart", i), Ot(ct, ut), lt.x = lt.y = 0, Ot(te, i[0]), Ot(ee, te), ne.x = pt.x * ht, oe = [{
								x : te.x,
								y : te.y
							}
						], N = H = Tt(), Wt(g, !0), fe(), pe()),
					!G && n > 1 && !et && !Q && (v = g, X = !1, G = $ = !0, lt.y = lt.x = 0, Ot(ct, ut), Ot(Gt, i[0]), Ot(Kt, i[1]), be(Gt, Kt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, K = he(Gt, Kt))
				}
			}
		},
		Ie = function (t) {
			...
			if (Z) {
				...
				if (0 !== t)
					if (Ot(Gt, Z[0]), Jt.x = Gt.x - te.x, Jt.y = Gt.y - te.y, G && t > 1) {
						...
						if (!it)
							return;
						if (nt && (nt = !1, Math.abs(Jt.x) >= 10 && (Jt.x -= Z[0].x - ee.x), Math.abs(Jt.y) >= 10 && (Jt.y -= Z[0].y - ee.y)), te.x = Gt.x, te.y = Gt.y, 0 === Jt.x && 0 === Jt.y)
							return;
		...
		De = function () {
			...
			i = {
				...
				calculateSwipeSpeed : function (n) {
					oe.length > 1 ? (t = Tt() - N + 50, e = oe[oe.length - 2][n]) : (t = Tt() - H, e = ee[n]),
		...
		Ee = function (t, e) {
			...
			h = pt.x * ht,
			f = Math.abs(h - ce.x);
			return i || h > ce.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? f / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333,
			re === u && (i = !1),
			et = !0,
		...
		xt("Gestures", {
			publicMethods : {
				initGestures : function () {
					...
					A ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : W.touch ? (t("touch", "start", "move", "end", "cancel"), D = !0) : t("mouse", "down", "move", "up"),
					f = T + " " + M + " " + I,
					p = S,
					...
					m[M] = Ae,
					I && (m[I] = m[M]),
					W.touch && (p += " mousedown", f += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[T], m.mouseup = m[M]),
		...
		Ve = function (e, i, n, s) {
			...
			h = function () {
				Xt("initialZoom"),
				n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))),
				s && s(),
				He = !1
			};
			if (!d || !l || void 0 === l.x)
				return St("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Ot(ut, e.initialPosition), Pt(), t.style.opacity = n ? 0 : 1, Mt(1), void(d ? setTimeout(function () {
						h()
					}, d) : h());
			!function () {
				var i = c,
				...
				Fe = setTimeout(function () {
						if (St("initialZoom" + (n ? "Out" : "In")), n) {
							...
							u = at,
							f = function (e) {
								1 === e ? (g = a, ut.x = l.x, ut.y = l.y - R) : (g = (a - c) * e + c, ut.x = (l.x - r.x) * e + r.x, ut.y = (l.y - R - r.y) * e + r.y),
								Pt(),
								s ? t.style.opacity = 1 - e : Mt(u - e * u)
							};
							i ? Qt("initialZoom", 0, 1, d, o.easing.cubic.out, f, h) : (f(1), Fe = setTimeout(h, d + 20))
						} else
							g = e.initialZoomLevel, Ot(ut, e.initialPosition), Pt(), Mt(1), s ? t.style.opacity = 1 : Mt(1), Fe = setTimeout(h, d + 20)
					}, n ? 25 : 90)
			}
			()
		},
			...
			publicMethods : {
				...
				initController : function () {
					...
					Ct("destroy", function () {
						for (var t, e = 0; e < Re.length; e++)
							(t = Re[e]).container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
						je = null
					})
				},
				...
				setContent : function (t, e) {
					...
					if (l) {
						...
						if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), $e(l, dt), !l.src || l.loadError || l.loaded)
							...
							if (l.loadComplete = function (i) {
								if (s) {
									if (t && t.index === e) {
										if (Ue(i, !0))
											return i.loadComplete = i.img = null, $e(i, dt) , At(i), void(t.index === u && a.updateCurrZoomItem());
						...
						We || e !== u ? At(l) : (tt = c.style, Ve(l, n || l.img)),
						t.el.innerHTML = "",
						t.el.appendChild(c)
					} else
						t.el.innerHTML = ""
			...
			publicMethods : {
				...
				handleMouseWheel : function (t) {
					if (g <= a.currItem.fitRatio)
						return r.modal && (!r.closeOnScroll || $t || Y ? t.preventDefault() : P && Math.abs(t.deltaY) > 2 && (c = !0, a.close())), !0;
					if (t.stopPropagation(), Ke.x = 0, "deltaX" in t)
						1 === t.deltaMode ? (Ke.x = 18 * t.deltaX, Ke.y = 18 * t.deltaY) : (Ke.x = t.deltaX, Ke.y = t.deltaY);
					else if ("wheelDelta" in t)
						t.wheelDeltaX && (Ke.x =  - .16 * t.wheelDeltaX), t.wheelDeltaY ? Ke.y =  - .16 * t.wheelDeltaY : Ke.y =  - .16 * t.wheelDelta;
					else {
						if (!("detail" in t))
							return;
						Ke.y = t.detail
	...
	return function (t, e) {
		...
		T = function (t) {
			...
			for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "", a = 0; a < N.length; a++)
				(i = N[a]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
			if (n) {
		...
		_ = function (e) {
			...
			!(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), C || D(), 1))
		},
		E = function () {
					...
					if (n)
						for (var a = n.length, r = 0; a > r; r++) {
							...
							for (var s = 0; s < N.length; s++)
								o = N[s], i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
						}
				};
				a(n.children);
		...
		x.onGlobalTap = function (i) {
			...
			if (!v)
				...
				} else if (g.tapToToggleControls && (k ? x.hideControls() : x.showControls()), g.tapToClose && (e.hasClass(n, "pswp__img") || O(n)))
					return void t.close()
		},
	...
	t.fn.material_chip = function (n) {
		...
		"data" === n ? this.$el.data("chips") : "options" === n ? this.$el.data("options") : (this.$el.data("options", t.extend({}, i, n)), this.init = function () {
			...
			o.$document.on("keydown", e.CHIPS + " " + e.INPUT, function (i) {
				...
				if (13 === i.which)
					return i.preventDefault(), o.addChip(r, {
						tag : n.val()
					}, a), void n.val("");
...
(jQuery), function (t) {
	...
	m.prototype.coverImage = function () {
		if (this.image.width && this.image.height) {
			...
			h = 0,
			f = 0;
			l && (c = s < 0 ? s * Math.max(i, o) : s * (i + o), s > 1 ? d = Math.abs(c - o) : s < 0 ? d = c / s + Math.abs(c) : d += Math.abs(o - i) * (1 - s), c /= 2),
			(u = d * a / r) < e && (d = (u = e) * r / a),
			l ? (h = n + (e - u) / 2, f = (o - d) / 2) : (h = (e - u) / 2, f = (i - d) / 2),
	...
	var y = function (t) {
		...
		for (var e, i = arguments[1], n = Array.prototype.slice.call(arguments, 2), o = t.length, a = 0; a < o; a++)
			if ("object" == typeof i || void 0 === i ? t[a].jarallax || (t[a].jarallax = new m(t[a], i)) : t[a].jarallax && (e = t[a].jarallax[i].apply(t[a].jarallax, n)), void 0 !== e)
				return e;
		return t
	};
	y.constructor = m;
...
(window), function (t) {
	...
	var n = function () {
		...
		return function (e, i) {
			...
			this.videoID && (this.ID = t++, this.loadAPI(), this.init())
		}
	}
	();
	...
	n.prototype.getIframe = function (e) {
		...
		n.$iframe ? e(n.$iframe) : n.onAPIready(function () {
			...
			if (n.$iframe || ((o = document.createElement("div")).style.display = "none"), "youtube" === n.type) {
				...
				n.playerOptions.events = {
					...
					onStateChange : function (t) {
						...
						u || t.data !== YT.PlayerState.PLAYING || (u = 1, n.fire("started", t)),
				...
				h && (n.$iframe = document.getElementById(n.playerID), n.videoWidth = parseInt(n.$iframe.getAttribute("width"), 10) || 1280, n.videoHeight = parseInt(n.$iframe.getAttribute("height"), 10) || 720)
			}
			...
			if ("local" === n.type) {
				if (!n.$iframe)
					for (var p in n.$iframe = document.createElement("video"), n.options.mute && (n.$iframe.muted = !0), n.options.loop && (n.$iframe.loop = !0), n.$iframe.setAttribute("id", n.playerID), o.appendChild(n.$iframe), document.body.appendChild(o), n.videoID)
						r = n.$iframe, s = n.videoID[p], l = "video/" + p, c = void 0, (c = document.createElement("source")).src = s, c.type = l, r.appendChild(c);
				var m;
